...
/// @title GriddyV5 — variable-stake native-token pari-mutuel 5x5 grid, continuous rounds
...
///         no reward token. UUPS-upgradeable (storage layout frozen from V2:
///         retired vars retained, unused).
contract GriddyV5 is Initializable, Ownable2StepUpgradeable, UUPSUpgradeable {
